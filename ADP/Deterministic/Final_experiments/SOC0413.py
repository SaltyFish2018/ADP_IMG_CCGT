...
###########################################################################
    ...
    for interval in range(2, periods+1):
        ...
        # battery1 = change.getConstrByName('battery1')
        # battery1.setAttr('rhs',4.5)
        # battery2 = change.getConstrByName('battery2')
        # battery2.setAttr('rhs',4.5)
        # SOC1 = change.getVarByName('SOC')
        # SOC1.setAttr('lb',0.5)
