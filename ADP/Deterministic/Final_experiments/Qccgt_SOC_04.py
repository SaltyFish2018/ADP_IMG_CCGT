...
plt.savefig('D:\\Nuts\CCGT\ADP\Deterministic\\02Power.jpeg',dpi=500,bbox_inches='tight')
plt.show()
...
# fig.tight_layout()
plt.grid(axis="y", linestyle='-.')
plt.savefig('D:\\Nuts\CCGT\ADP\Deterministic\\02Heat.jpeg',dpi=500,bbox_inches='tight')
...
# path = 'D:\\Nuts\CCGT\ADP\Deterministic\\0212ADP_penalty.csv'
