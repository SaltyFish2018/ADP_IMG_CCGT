...
for interval in intervals:
    strategy.addConstr( (Q_GB[interval] + Q_HP[interval] +  Q_cur[interval]) + 0.4031 * Q_X1[18*interval] \
                        + 0.3656 * Q_X2[18*interval]+ 0.06311 * Q_X3[18*interval] + 0.2087 * Q_X4[18*interval] - demand_Heat[interval] == 0)
...
#
outputpath1 = 'D:\\Nuts\CCGT\MILP\\0417MILP_Q_CCGT_all.csv'
...
#
outputpath3 = 'D:\\Nuts\CCGT\MILP\\0417MILP_Q_CCGT.csv'
